...
#define TEMPERATURE_SDA_BV		BV(5)
#define TEMPERATURE_SDA_SBIT		P0_5
#define TEMPERATURE_SDA_DDR		P0DIR
#define TEMPERATURE_SDA_POLARITY	ACTIVE_HIGH
	
#define TEMPERATURE_SCL_BV		BV(4)
#define TEMPERATURE_SCL_SBIT		P0_4
#define TEMPERATURE_SCL_DDR		P0DIR
#define TEMPERATURE_SCL_POLARITY	ACTIVE_HIGH
